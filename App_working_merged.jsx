            ...
            {waves.length > 0 ? (
              waves.map((wave) => {
                ...
                const recentMinutes = wave.events?.[0]?.timestampUtc
                  ? Math.floor(
                      (Date.now() -
                        parseEventDate(wave.events[0].timestampUtc).getTime()) /
                        60000,
                    )
                  : 999;
              ...
              <div style={{ color: palette.textSoft, fontSize: 13 }}>
                No live events yet. Trigger /test-sweep or wait for the scanner.
              </div>
            )}
          </div>
        </div>
        ...
        <div style={{ padding: 12, display: "grid", gap: 12 }}>
          ...
          >
            ...
            <select
              ...
              onChange={(e) => updateDecision("executionType", e.target.value)}
            >
            ...
            <select
              ...
              onChange={(e) => updateDecision("liquidityLevel", e.target.value)}
            >
