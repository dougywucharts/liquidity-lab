                    ...
                    <div
                      ...
                      style={{
                        ...
                        borderColor: getToneBorder(
                          directionTone(wave.directionBias),
                        ),
                      }}
                    >
                      {/* TOP ROW (MINIMAL) */}
                        ...
                        >
                          <div
                            style={{
                              fontWeight: 900,
                              color:
                                (wave.avgConfidence || 0) >= 0.8
                                  ? palette.long
                                  : (wave.avgConfidence || 0) >= 0.6
                                    ? palette.gold
                                    : palette.short,
                            }}
                          >
                            {(wave.avgConfidence * 100).toFixed(0)}%
                          </div>
                          ...
                          >
                            {expandedWaves[wave.key] ? "Hide" : "Show"}
                          </button>
                        </div>
                      </div>

                      {/* EXPANDED SECTION */}
                      {expandedWaves[wave.key] && (
                        <div
                          style={{
                            padding: "12px 14px",
                            borderTop: `1px solid ${palette.borderSoft}`,
                        ...
                        >
                          ...
                          >
                            ...
                            <Pill>{wave.eventType}</Pill>
                            <Pill>{wave.sweepType}</Pill>
            ...
            <div style={styles.journalShell}>
              ...
              <div style={{ padding: 12, display: "grid", gap: 12 }}>
                ...
                <div
                  style={{
                    display: "grid",
                    gridTemplateColumns: journalExpanded
                ...
                >
                  ...
                  <select
                    ...
                    onChange={(e) =>
                      updateDecision("timeframe", e.target.value)
                    }
                  >
                  ...
                  <select
                    style={fieldStyle}
                    value={decisionForm.session}
                    onChange={(e) => updateDecision("session", e.target.value)}
                  >
                    {["New York", "London", "Asia", "Off Hours"].map((v) => (
                      <option key={v}>{v}</option>
                    ))}
                  </select>
                  <select
                  ...
                  <select
                    ...
                    onChange={(e) =>
                      updateDecision("eventType", e.target.value)
                    }
                  >
                  ...
                  <select
                    ...
                    onChange={(e) =>
                      updateDecision("ruleBreak", e.target.value)
                    }
                  >
                    {[
                      "None",
