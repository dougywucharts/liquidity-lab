...
function LightweightExecutionChart({ event }) {
  ...
  useEffect(() => {
    ...
    setLevelLine(event.entry, "#60a5fa");
    setLevelLine(event.stop, "#ef4444");
    setLevelLine(event.tp1, "#4ade80");
    setLevelLine(event.tp2, "#86efac");
    [
      ["ENTRY", event.entry, "#60a5fa"],
      ["STOP", event.stop, "#ef4444"],
      ["TP1", event.tp1, "#4ade80"],
      ["TP2", event.tp2, "#86efac"],
