...
const ui = {
  ...
  radarIconBox: {
    ...
    boxShadow: "0 0 24px rgba(255,26,26,0.12)",
    flexShrink: 0,
  },
  radarIcon: {
    width: 22,
  ...
  split: {
    display: "grid",
    gridTemplateColumns: "minmax(320px, 1.05fr) minmax(380px, 0.95fr)",
    gap: 14,
  },
  blockTitle: {
    fontSize: 12,
  ...
  eventButtonSelected: {
    width: "100%",
    textAlign: "left",
    background: "linear-gradient(180deg, rgba(255,26,26,0.12), rgba(20,20,20,1))",
    border: "1px solid rgba(255,26,26,0.28)",
    borderRadius: 18,
    padding: 14,
    color: "#F2F2F2",
                  ...
                  >
                    <div style={{ display: "flex", justifyContent: "space-between", gap: 10, alignItems: "center", flexWrap: "wrap" }}>
                      <div style={{ display: "flex", gap: 8, alignItems: "center", flexWrap: "wrap" }}>
                        ...
                        <span style={event.directionBias === "Long" ? ui.pill : ui.redPill}>{event.directionBias}</span>
                    ...
                    <div style={{ marginTop: 10, display: "grid", gap: 6 }}>
                      <div style={{ fontWeight: 800 }}>{event.sweepType}</div>
