...
const styles = {
  ...
  mainGrid: {
    display: "grid",
    gridTemplateColumns: "380px minmax(480px, 1fr) 380px",
    gap: 12,
    alignItems: "start",
  },
  panel: {
    ...
    <div style={styles.app}>
      <div style={styles.shell}>
        ...
        <div style={styles.mainGrid}>
              ...
              >
                ...
                >
                  ...
                  >
                    ...
                    {selectedEvent?.timeframe || decisionForm.timeframe || "1m"}
                  </div>
                </div>
              </div>
            ) : null}
          ...
          <div style={{ ...styles.panelBody, paddingTop: 10 }}>
            <div style={styles.rightPanelGroup}>
              <div style={styles.topCardRow}>
                <MiniBox
                  label="Entry"
          ...
          <div style={styles.journalHeader}>
            ...
            >
              ...
              <button
                ...
                type="button"
              >
                {journalExpanded ? "Compact View" : "Full View"}
              </button>
        ...
        <div style={styles.journalShell}>
          ...
          <div
            style={{
              ...
              display: "grid",
              gap: 10,
              maxHeight: journalExpanded ? 760 : 420,
              overflowY: "auto",
            }}
          >
        ...
        <div style={styles.panel}>
          <div style={styles.panelHeader}>
            <div>
              ...
              <div style={styles.subtext}>Current event and prop controls.</div>
            </div>
          </div>
